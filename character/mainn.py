...
# Daftar karakter - gunakan forward slash (/) atau os.path.join untuk cross-platform
CHARACTERS = [
    {"name": "Yan", "path": r"character\assets\Samurai\Idle.png", "frames": 6},
    {"name": "Ras", "path": r"character\assets\Shinobi\Idle.png", "frames": 6},
    {"name": "Hen", "path": r"character\assets\Fighter\Idle.png", "frames": 6},
    {"name": "Converted Vampire", "path": r"character\assets\Vampire1\Idle.png", "frames": 5},
    {"name": "Countess Vampire", "path": r"character\assets\Vampire2\Idle.png", "frames": 5},
    {"name": "Vampire Girl", "path": r"character\assets\Vampire3\Idle.png", "frames": 5},
]
class CharacterSlot:
    def __init__(self, char_data, x, y, slot_width=200, slot_height=220):
        ...
        try:
            ...
            full_path = os.path.abspath(char_data["path"])
            print(f"\n[DEBUG] Loading {self.name}:")
            print(f"  - Path: {char_data['path']}")
            print(f"  - Full path: {full_path}")
            print(f"  - Exists: {os.path.exists(char_data['path'])}")
...
class CharacterSelection:
    ...
    def run(self):
        """Run character selection and return selected character name or None if cancelled"""
...
if __name__ == "__main__":
    ...
    if result:
        print(f"Selected character: {result}")
    else:
